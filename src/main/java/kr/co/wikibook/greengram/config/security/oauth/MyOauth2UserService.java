...
import kr.co.wikibook.greengram.application.user.UserRepository;
...
import kr.co.wikibook.greengram.config.security.oauth.userinfo.Oauth2UserInfo;
import kr.co.wikibook.greengram.config.security.oauth.userinfo.Oauth2UserInfoFactory;
...
public class MyOauth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User process(OAuth2UserRequest req) {
        ...
        if(user == null) { // 최초 로그인 상황 > 회원가입 처리
            ...
            // 최초 소셜 로그인은 회원가입으로 권한은 USER_1처리
